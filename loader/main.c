/* main.c -- Professor Layton: Diabolical Box HD .so loader
 *
...
enum MethodIDs {
	...
	MO_SetVolume,
	DL_GetFileName,
	PERMISSION_CheckGranted,
	OS_GetDeviceLanguage
} MethodIDs;
...
static NameToMethodID name_to_method_ids[] = {
	...
	{ "PERMISSION_CheckGranted", PERMISSION_CheckGranted },
	{ "OS_GetDeviceLanguage", OS_GetDeviceLanguage },
};
...
void *CallObjectMethodV(void *env, void *obj, int methodID, uintptr_t *args) {
	...
	case CARD_GetFilesDirName:
		return "ux0:data/layton_pandora";
	case UI_GetEditText:
		return get_ime_dialog_result();
	case DL_GetFileName:
		return "ux0:data/layton_pandora/data/main.obb";
	}
	return NULL;
}
...
int CallBooleanMethodV(void *env, void *obj, int methodID, va_list args) {
	...
	case MO_PlayMovie:
		...
		sprintf(fname, "ux0:data/layton_pandora/assets/%s", file);
...
void *real_main(void *argv) {
	...
	*(uintptr_t *)(fake_env + 0x36C) = (uintptr_t)GetJavaVM;
	...
	int (* setViewSize)(void *env, void *obj, int w, int h) = (void *)so_symbol(&layton_mod, "setViewSize");
